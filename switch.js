...
//is a weekday or weekend. All other cases output a message explaining that input must be a number between 1 and 7.
...
//4.	Write a program that for a 1-12 number input (representing a month in a year) shows that month’s 
//name. All other cases output a message explaining that input must be a number between 1 and 12. 
...
//5.	Write a program that for a 1-12 number input (representing a month in a year) shows 
//what season it is. All inputs different from 1-12 output a message explaining that input must 
...
//about that grade in the following manner: A - "Good job"", B - "Pretty good"", C - "Passed"", D - 
//"Not so good"", F - "Failed". Input different from letters A-F outputs a message "Unknown grade".
